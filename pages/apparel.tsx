...
import { createApparel, getApparels } from '../services/apparelService'
...
const Apparel: NextPage = (data) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            let response = await createApparel(body, user.token)
                .then((data) => {
                    fetchData()
                    return data
                })
    ...
    return (
        <>
            ...
            <main className="flex flex-col p-5 font-jost">
                <p className="font-bold text-4xl mb-10 font-sans">Apparels</p>
                ...
                <div className="flex flex-col space-y-5">
                    {products?.length > 0 ? (
                        ...
                        <div>There are not apparels {products}</div>
                    )}
                    {
                        visualAlert && <PopUpAlert
                            isSuccess={successAlert}
                            successMessage="Apparel added successful"
                            deniedMessage="Apparel added denied"
