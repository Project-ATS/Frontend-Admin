...
import {
    createMetaverseEvent,
    getMetaverseEvents,
} from '../services/metaverseEventsService'
import { isWeb3 } from '../services/walletService'
// import products from "../data/products.json"
import { useAppSelector } from '../state/hooks'

const MetaverseEvents: NextPage = (data) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            let response = await createMetaverseEvent(body, '', user.token)
                .then((data) => {
                    fetchData()
                    return data
                })
    ...
    const fetchData = async () => {
        const data = await getMetaverseEvents()
    ...
    return (
        <>
            ...
            <main className="flex flex-col p-5 font-jost">
                <p className="font-bold text-4xl mb-10 font-sans">
                    Metaverse Events
                </p>
                ...
                <div className="flex flex-col space-y-5">
                    ...
                    )}
                    {
                        visualAlert && <PopUpAlert
                            ...
                            successMessage="Metaverse Event added successful"
                            deniedMessage="Metaverse Event added denied"
...
export default MetaverseEvents
